...
Widget build(BuildContext context) {
  final cellSize = MediaQuery.of(context).size.width / (SnakeGame.gridSize + 2);
  ...
  GestureDetector(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        border: Border.all(color: const Color.fromARGB(255, 145, 247, 150), width: 2),
      ...
      child: Stack(
        children: [
          ...
          // Змейка
          for (int i = 0; 1 < _game.snake.lenght; i++)
          Positioned(
            left: SnakeGame[i].x * cellSize,
            top: SnakeGame[i].y * cellSize,
            child: Container(
              width: cellSize,
              height: cellSize,
              decoration: BoxDecoration(
                color: i == 0 ? Colors.green[700] : const Color.fromARGB(255, 86, 218, 91),
                borderRadius: BorderRadius.circular(cellSize / 4),
                border: i == 0
                    ? Border.all(color: const Color.fromARGB(255, 33, 163, 41), width: 2)
                    : Border.all(color: const Color.fromARGB(255, 40, 136, 45), width: 1),
              ),
            ),
          ),
        ],
